...
const ALLTESTS = {
	0: { // regular positioning
		41: { fStruct: () => makeTreeNNEach(2, 4), options: { params: { 
			'_1': { orientation: 'h' }, 
		...
		17: { fStruct: () => makeTreeNNEach(2, 4), options: { fContent: contentNoParentContent, params: { '_1': { orientation: 'w', rows: 1, cols: 2 }, '_1': { contentwalign: 'center', orientation: 'w', rows: 2, cols: 2 }, '_7': { orientation: 'w', rows: 2, cols: 2 } } } },
		16: { fStruct: () => makeTreeNNEach(2, 4), options: { fContent: contentNoParentContentRootExtralong, params: { '_1': { orientation: 'w', rows: 1, cols: 2 }, '_1': { orientation: 'w', rows: 2, cols: 2 }, '_7': { orientation: 'w', rows: 2, cols: 2 } } } },
