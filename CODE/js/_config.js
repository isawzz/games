...
const TEST_VERSION = '04'; // | null to use genauere
const TEST_PATH = '/DATA/';

const DSPEC_PATH = '/DATA/defaultSpec';
const SPEC_PATH = '/DATA/_spec0';
const SERVERDATA_PATH = '/DATA/_serverData';
