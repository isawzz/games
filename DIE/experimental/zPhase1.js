...
function zItems(infos, ifs, { repeat = 1, colorKeys, shufflePositions = false }) {
	//console.log(ifs); 
	let options = arguments[2]; //console.log(options);
	let itKeys = [];
	...
	//colorKeys: copy colors.length times into different colors
	let itColors = [];
	if (isdef(colorKeys)) {
